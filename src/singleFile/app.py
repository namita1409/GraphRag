...
from singleFile.entity_relationship_extraction import get_entities_relationships
from singleFile.visualize_graph import plot_knowledge_graph
...
text_file_path = "./data/raw_text_small.txt"
